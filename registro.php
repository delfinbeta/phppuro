    ...
    <main class="m-auto p-4 text-white bg-primary bg-gradient rounded-4" style="width: 320px;">
        ...
        <form action="controllers/register.php" method="POST" class="needs-validation" novalidate>
            <div class="mb-3">
                ...
                <input type="text" id="firstname" name="firstname" class="form-control <?php if (isset($_SESSION['errors']['firstname'])) { echo 'is-invalid'; } ?>" aria-describedby="error_firstname" required />
            ...
            <div class="mb-3">
                ...
                <input type="text" id="lastname" name="lastname" class="form-control <?php if (isset($_SESSION['errors']['lastname'])) { echo 'is-invalid'; } ?>" aria-describedby="error_lastname" required />
            ...
            <div class="text-center">
                <a href="index.php" class="link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-75-hover">
                    Iniciar Sesión
                </a>
            </div>
        </form>
